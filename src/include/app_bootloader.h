...
#define IMAGE_OTA_ADDR1         (FLASH_ADDR_OF_OTA_IMAGE - 0x7000) //0x70000
#define IMAGE_OTA_ADDR2         FLASH_ADDR_OF_OTA_IMAGE
#define IMAGE_OTA_ADDR_END      NV_BASE_ADDRESS //0xE6000   /* for 1M flash module */
#define IMAGE_OTA_SIZE          FLASH_OTA_IMAGE_MAX_SIZE    /* tuya addr 0x70000, ota_end 0xe6000, e6000-70000=68000 */
